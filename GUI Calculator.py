...
def calculate():
    ...
    try:
        ...
        messagebox.showinfo('Attention!', 'Enter only numbers!!!')
        calc.insert(0, 0)
...
def make_digit_button(digit):
    return tk.Button(text=digit, bd=5, font=('Ariel', 20),
                     command=lambda: add_digit(digit))


def make_operation_button(operation):
    return tk.Button(text=operation, bd=5, font=('Ariel', 20), fg='#FF0000',
...
root.geometry(f'240x335+300+300')
root['bg'] = '#F08080'

root.bind('<Key>', press_key)

calc = tk.Entry(root, justify=tk.RIGHT, font=('Ariel', 20), width=15)
calc.insert(0, '0')
